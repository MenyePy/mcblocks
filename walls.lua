...
walls.register("mcblocks:andesite_wall", ("Andesite Wall"), {"andesite.png"},
		"mcblocks:andesite", default.node_sound_stone_defaults())
		

walls.register("mcblocks:diorite_wall", ("Diorite Wall"), {"diorite.png"},
		"mcblocks:diorite", default.node_sound_stone_defaults())
		
		
walls.register("mcblocks:granite_wall", ("Granite Wall"), {"granite.png"},
		"mcblocks:granite", default.node_sound_stone_defaults())